	...
	education.forEach(function(element) {
		...
		$.getJSON("contents/education/" + element + ".json", function(school) {
			...
			$("#"+element).each(function() {
				...
				$("<br>").appendTo(this)
				$("<span class=\"scool_activities\">Activities</span>").appendTo(this)
				var activities = $("<ul></ul>")
				liFromList(school.activities || [], activities, false)
				activities.appendTo(this)
				$("<span class=\"school_courses\">Notable Coursework</span>").appendTo(this)
				var courses = $("<ul class=\"coursework\"></ul>")
